...
pub fn get_user_stack_address(app_id: usize) -> Range<usize> {
    let user_stack_start = &USER_STACK[app_id] as *const _ as usize;
    user_stack_start..user_stack_start+USER_STACK_SIZE
}

pub fn get_app_address(app_id: usize) -> Range<usize> {
